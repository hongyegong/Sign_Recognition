...
#define WINDOW_NAME_FEATURE_ROI "8. Feature ROI"
#define WINDOW_NAME_FEATURE_MATCHES "9. Digits features matches"
#define WINDOW_NAME_FEATURE_GOOD_MATCHES "9. Digits features good matches"
...
class ImageAnalysis {
	public:
		...
		int  reg(char *fileName);
		int div(char* fileName);
		IplImage* getImage(IplImage *workImg, CvPoint start, int with, int Hight);
